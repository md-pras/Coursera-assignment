...
## Problem 1
Create the following animation with gganimate, using the data generated in the code
...
## Problem 2
Create the following interactive figure, using the data generated in the code
...
gg <- ggplot(my_dat, aes(x=Company, y=Output)) +
...
## Problem 3
Create the following animation animated figure, using the data generated in the code
...
library(plotly)
gg2 <- ggplot(dat3, aes(x=Category, y=Quantity, frame=Time)) +
  geom_point() +
